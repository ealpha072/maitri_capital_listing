  ...
  return (
    ...
    >
      {stats.map((s, i) => (
        ...
        >
          <div style={{ fontFamily: "'Cormorant Garamond', serif", fontSize: isMobile ? 30 : 38, fontWeight: 300, color: T.gold, lineHeight: 1 }}>
            {s.num}
          </div>
          <div style={{ fontSize: 8, letterSpacing: "0.28em", textTransform: "uppercase", color: "rgba(255,255,255,0.38)", marginTop: 8 }}>
            {s.label}
          </div>
        </div>
      ))}

...
export const PhilosophySection = () => {
  ...
  return (
    ...
    >
      <div style={{ position: "relative", height: isMobile ? 300 : isTablet ? 420 : 540 }}>
        <img
...
const StepItem = ({ n, t, d, i, cols }) => {
  ...
  return (
    ...
    >
      <div style={{ fontFamily: "'Cormorant Garamond', serif", fontSize: 52, fontWeight: 300, color: hov ? T.goldMuted : "rgba(191,144,0,0.1)", lineHeight: 1, marginBottom: 20, transition: "color 0.3s" }}>
        {n}
      </div>
...
export const Testimonial = () => {
  ...
  return (
    <section style={{ padding: isMobile ? "70px 24px" : "110px 60px", background: T.warmWhite, textAlign: "center", position: "relative", overflow: "hidden" }}>
      <div style={{ position: "absolute", top: -60, left: "50%", transform: "translateX(-50%)", fontFamily: "'Cormorant Garamond', serif", fontSize: isMobile ? 180 : 280, fontWeight: 300, color: "rgba(191,144,0,0.05)", lineHeight: 1, pointerEvents: "none" }}>
        "
      </div>
      ...
      <div style={{ fontSize: 12, color: T.slateLight, marginTop: 6, letterSpacing: "0.1em" }}>

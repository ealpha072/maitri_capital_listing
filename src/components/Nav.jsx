  ...
  return (
    <>
      ...
      >
        ...
        >
          <div style={{ fontFamily: "'Cormorant Garamond', serif", fontSize: isTablet ? 18 : 21, color: scrolled || menuOpen ? T.slateDark : "white", letterSpacing: "0.12em", lineHeight: 1.2 }}>
            Maitri Capital
          </div>
          ...
          <div style={{ display: "flex", alignItems: "center", gap: 36 }}>
            {["Portfolio", "Philosophy", "Process", "Contact"].map((l) => (
              <a
                key={l}
                href={`#${l.toLowerCase()}`}
                style={{ fontSize: 11, letterSpacing: "0.24em", textTransform: "uppercase", color: textColor, textDecoration: "none", transition: "color 0.3s" }}
            ...
            <button
              onClick={onAdmin}
              style={{ fontSize: 10, letterSpacing: "0.28em", textTransform: "uppercase", color: adminMode ? "white" : T.gold, border: `1px solid ${T.gold}`, background: adminMode ? T.gold : "transparent", padding: "9px 22px", cursor: "pointer", transition: "all 0.3s" }}
        ...
        {isTablet && (
          <button
            ...
            style={{ background: "none", border: "none", cursor: "pointer", display: "flex", flexDirection: "column", gap: 5, padding: 4, color: scrolled || menuOpen ? T.slateDark : "white" }}
          >
        ...
        <div style={{ position: "fixed", top: 0, left: 0, right: 0, bottom: 0, zIndex: 199, background: "rgba(250,248,244,0.98)", backdropFilter: "blur(16px)", display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", gap: 8 }}>
          {["Portfolio", "Philosophy", "Process", "Contact"].map((l) => (
            <a
              ...
              style={{ fontSize: 13, letterSpacing: "0.3em", textTransform: "uppercase", color: T.slate, textDecoration: "none", padding: "16px 40px", display: "block" }}
            >
              {l}
            </a>
          ))}
          ...
          <button
            ...
            style={{ fontSize: 10, letterSpacing: "0.28em", textTransform: "uppercase", color: T.gold, border: `1px solid ${T.gold}`, background: "transparent", padding: "12px 32px", cursor: "pointer" }}
          >
            {adminMode ? "← Public View" : "Admin"}
          </button>
        </div>

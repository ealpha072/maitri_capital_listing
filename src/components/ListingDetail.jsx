...
const ListingDetail = ({ listing, onBack }) => {
  ...
  return (
    <div style={{ background: T.cream, minHeight: "100vh" }}>
      ...
      >
        ...
        <div
          style={{
            position: "absolute",
            inset: 0,
            background: "linear-gradient(to top, rgba(26,31,38,0.88) 0%, rgba(26,31,38,0.2) 60%, transparent 100%)"
          }}
        />
        <button
          onClick={onBack}
        ...
        >
          ...
          <h1
            style={{
              ...
              fontSize: isMobile ? "clamp(30px,8vw,48px)" : "clamp(40px,6vw,76px)",
              fontWeight: 300,
              color: "white",
              lineHeight: 1.05,
        ...
        {metrics.map((m, i) => (
          <div
            ...
            style={{
              ...
              : (i < metrics.length - 1 ? "1px solid rgba(255,255,255,0.07)" : "none"),
      ...
      <div
        style={{
          padding: isMobile ? "52px 20px" : isTablet ? "64px 32px" : "90px 60px",
          display: "grid",
              ...
              {listing.highlights.map((h, i) => (
                <div
                  ...
                  style={{
                    ...
                    paddingBottom: 12,
                    marginBottom: 12,
                    borderBottom: i < listing.highlights.length - 1 ? `1px solid ${T.border}` : "none"
                  }}
                >
                  <div
                    style={{
